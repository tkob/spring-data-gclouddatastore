...
public class UnmarshallerTests {
	...
	public void testUnmarshalToObject_Double() {
		// Setup
		Key key = Key.newBuilder("project", "kind", 1).build();
		Entity entity = Entity.newBuilder(key).set("object", 3.14)
				.set("boxedDouble", 3.14).set("primitiveDouble", 3.14)
				.set("boxedFloat", 3.14).set("primitiveFloat", 3.14)
				.set("boxedLong", 3.14).set("primitiveLong", 3.14)
	...
	public void testUnmarshalToObject_Long() {
		// Setup
		Key key = Key.newBuilder("project", "kind", 1).build();
		Entity entity = Entity.newBuilder(key).set("object", 42).set("boxedLong", 42)
				.set("primitiveLong", 42).set("boxedInteger", 42).set("primitiveInt", 42)
				.set("boxedShort", 42).set("primitiveShort", 42).set("boxedByte", 42)
	...
	public void testUnmarshalToObject_String() throws Exception {
		// Setup
		Key key = Key.newBuilder("project", "kind", 1).build();
		Entity entity = Entity.newBuilder(key).set("object", "hello")
				.set("string", "hello").set("bytes", "hello").set("boxedLong", "42")
				.set("primitiveLong", "42").set("boxedInteger", "42")
				.set("primitiveInt", "42").set("boxedShort", "42")
				.set("primitiveShort", "42").set("boxedByte", "42")
