...
@Documented
@Inherited
@Import(GcloudDatastoreRepositoriesRegistrar.class)
public @interface EnableGcloudDatastoreRepositories {

	/**
	 * Alias for the {@link #basePackages()} attribute. Allows for more concise annotation
	 * declarations e.g.: {@code @EnableGcloudDatastoreRepositories("org.my.pkg")} instead
	 * of {@code @EnableGcloudDatastoreRepositories(basePackages="org.my.pkg")}.
	 */
	 ...
	 * Defaults to {@link GcloudDatastoreRepositoryFactoryBean}.
	 *
	 * @return
	 */
	Class<?> repositoryFactoryBeanClass() default GcloudDatastoreRepositoryFactoryBean.class;
